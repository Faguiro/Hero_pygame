...
hero_stand = pygame.transform.rotozoom(pygame.image.load( "graphics/hero/hero_big.png").convert_alpha(), 0 , 0.4)  # rotation, scale
hero_stand_rect = hero_stand.get_rect(center=(400, 300))
game_message = test_font.render( "Pressione espaço para começar", False, (64, 64, 64)).convert()
